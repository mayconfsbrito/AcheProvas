...
public class ArrayAdapterBusca extends ArrayAdapter<HashMap<String, String>> {
	
	private int resource;

	public ArrayAdapterBusca(Context context, int textViewResourceId, ArrayList<HashMap<String, String>> array) {
